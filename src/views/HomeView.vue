...
<template>
  <main class="w-[100%] flex justify-between">
    ...
    <div
      class="right flex items-center justify-center h-[90vh] mt-[-70px] w-[40%] rounded-tl-[300%] rounded-bl-[100%]"
    >
      <img src="../assets/images/aocholProfile.png" alt="" />
    </div>
  </main>
</template>
<style scoped>
